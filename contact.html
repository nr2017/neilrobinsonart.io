...
<div class="w3-top">
  <div class="w3-bar w3-blue-grey w3-card">
    ...
    <a href="index.html" class="w3-bar-item w3-button w3-padding-large"><strong>NEIL ROBINSON</strong></a>
	...
	<a href="contact.html" class="w3-bar-item w3-button w3-padding-large w3-hide-small"><b>contact</b></a>
...
<div id="navBar" class="w3-bar-block w3-blue-grey w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
  ...
  <a href="contact.html" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()"><b>contact</b></a>
</div>
